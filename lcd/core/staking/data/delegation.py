...
from lcd.core import AccAddress, Coin, Dec, ValAddress
from lcd.util.json import JSONSerializable
...
class Redelegation(JSONSerializable):
    ...
    def from_data(cls, data: dict) -> Redelegation:
        entries = [RedelegationEntry.from_data(re['redelegation_entry']) for re in data["entries"]]
        return cls(
